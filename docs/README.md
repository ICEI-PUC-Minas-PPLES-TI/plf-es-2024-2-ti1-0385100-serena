...
| --------------------- | ------------------------------------------ | -------------------------------------- |
| Usuário do sistema   | Averiguar a veracidade de informações de forma prática e fácil | Ter certeza que posso confiar no que estou lendo |
| Usuário do sistema   | Um mecanismo de pesquisa baseado em sintomas | Possa identificar o que está acontecendo comigo e se isso enquadra em saúde mental |
| Usuário do sistema   | Anonimidade e privacidade | Possa compartilhar os detalhes do que sinto sem medo de ser exposto |
| Usuário do sistema   | Acessar o aplicativo em qualquer sistema gratuitamente | Independente da minha condição socioecoônimca, tenha acesso ao aplicativo |
...
![Exemplo de proposta de valor](https://github.com/ICEI-PUC-Minas-PPLES-TI/plf-es-2024-2-ti1-0385100-ti-aw-grupo-5/blob/master/docs/images/prop2.png)
![Exemplo de proposta de valor](https://github.com/ICEI-PUC-Minas-PPLES-TI/plf-es-2024-2-ti1-0385100-ti-aw-grupo-5/blob/master/docs/images/prop3.png)
